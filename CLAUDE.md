...
**Documentation is split across directories.** Each `src/` subdirectory has its own `CLAUDE.md` with context relevant to that area. Only app-wide essentials are here.
