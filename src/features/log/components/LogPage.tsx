		...
		<div className="space-y-4">
			...
			{activeFilterCount > 0 && (
				<div className="flex items-center gap-2 flex-wrap">
					...
					<button
						...
						className="text-xs text-[var(--color-neutral)] hover:text-[var(--color-neutral-hover)]"
					>
						{t('chips.clearAll')}
					</button>
				</div>
			...
			{!hasItems ? (
				<div className="text-center py-12">
					...
					<Link to="/library" className="text-[var(--color-neutral)] hover:underline">
				...
				<div className="text-center py-12">
					...
					{activeFilterCount > 0 ? (
						<button type="button" onClick={clearAllFilters} className="text-[var(--color-neutral)] hover:underline">
