...
- **`CategoryDetailPage.tsx`** — Detail page for category-based dashboard cards (`/stats/category/:categoryId`). Shows weekly summary and, for `limit` sentiment categories, a small motivation pill displaying days since the last logged entry.
