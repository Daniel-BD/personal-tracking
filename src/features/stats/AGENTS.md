...
- **`CategoryComposition.tsx`** — Stacked/bar chart showing weekly category distribution using the top 20 most commonly logged categories across the visible range, with remaining categories grouped into `Other`.
