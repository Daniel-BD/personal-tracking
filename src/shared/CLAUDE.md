...
- **`EntityMetaBadges.tsx`** — Shared entity metadata helpers: `EntityHeaderMeta` (accent dot + activity/food pill) and `CategorySentimentPills` (small sentiment-colored default-category pills used in Stats add modal and Library rows).
